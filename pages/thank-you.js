    ...
    <Layout title="Спасибо за заявку" description="Заявка отправлена. Мы свяжемся с вами в ближайшее время.">
      ...
      <section className="relative overflow-hidden flex items-center justify-center px-4" style={{ minHeight: 'calc(100vh - 80px)' }}>
        ...
        <div className="relative z-10 text-center max-w-2xl mx-auto py-24">
          ...
          <p className="text-zinc-300 text-xl leading-relaxed mb-4">Спасибо! Мы получили вашу заявку и свяжемся с вами в ближайшее время.</p>
          <p className="text-zinc-500 text-base mb-10">Обычно отвечаем в течение рабочего дня. Если срочно — звоните: <a href="tel:+79273412252" className="text-red-400 hover:text-red-300 transition-colors whitespace-nowrap">+7 927 341-22-52</a></p>

    ...
    <Layout title="Вирусные видеоролики" description="Создаём вирусный контент для industrial-аудитории: производства, стройки, добыча, вахта. Ролики, которые пересылают в Telegram.">
      ...
      <section className="px-4 sm:px-6 py-20 max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-4 gap-4 mt-16 mb-24">
          {[['1500+','Снятых вертикальных роликов'],['1M+','Подписчиков суммарно в соцсетях'],['2021','Стояли у истоков reels'],['B2B','Специализация на сложных нишах']].map(([v,l]) => <StatBlock key={l} value={v} label={l} />)}
        </div>

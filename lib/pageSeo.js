...
export const PAGE_DEFAULTS = {
  ...
  '/brief':         { label: 'Бриф',                     title: 'Заполнить бриф RGUARD — вирусный контент и продюсирование', description: 'Заполните бриф RGUARD: расскажите о задаче, аудитории и контактах, чтобы мы предложили подход к вирусному контенту, SMM или мероприятию.' },
